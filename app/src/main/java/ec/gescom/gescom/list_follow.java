 ...
 * {@link list_follow.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link list_follow#newInstance} factory method to
 * create an instance of this fragment.
 */
public class list_follow extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.list_follow, container, false);
        /////para el home
    ...
    private void consultarListaPersonas() {
        ...
        Cursor cursor=db.rawQuery("SELECT cedula_cns, nombre, sum(total_deuda), count(*) FROM "+ AyudaBD.DatosTabla.NOMBRE_TABLA +" where estado=2 group by cedula_cns, nombre",null);
